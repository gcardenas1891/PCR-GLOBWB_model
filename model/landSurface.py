    ...
    def update(self,meteo,groundwater,routing,currTimeStep):
        ...
        for coverType in self.coverTypes: 
            ...
            if coverType.startswith("irr"):
                ...
                self.satisfied_irrigation_water_height[coverType] = self.landCoverObj.satisfied_irrigation_water_volume[coverType] / (self.routing.cellArea * self.landCoverObj[coverType].fracVegCover)
