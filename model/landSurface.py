        ...
        for coverType in self.coverTypes: 
            ...
            if coverType.startswith("irr"):
                ...
                self.satisfied_irrigation_water_volume[coverType] = total_satisfied_irrigation_water_volume *\
                                                                                            vos.getValDivZero( self.water_demand.water_demand_irrigation[coverType].irrGrossDemand * self.routing.cellArea * self.landCoverObj[coverType].fracVegCover, vol_gross_sectoral_water_demands["irrigation"])
